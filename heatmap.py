...
def get_params():
    params = {
        'weight': '/home/fengrenchen/Code/ultralytics-yolo11-main/runs/train/YOLO_11_voc_22/weights/best.pt', # 现在只需要指定权重即可,不需要指定cfg
        'device': 'cuda:0',
...
if __name__ == '__main__':
    ...
    model(r'/home/fengrenchen/Code/yolo11-new/TestImage', './result/pure')
