...
if __name__ == '__main__':
    model_path = '/home/fengrenchen/Code/yolo11-new/runs/COCO/train_hyper_MFM_2/exp3/weights/best.pt'
    model = YOLO(model_path) # 选择训练好的权重路径
    result = model.val(data='/home/fengrenchen/Code/yolo11-new/COCO.yaml',
